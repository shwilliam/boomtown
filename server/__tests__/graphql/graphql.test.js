...
describe('GraphQL Schema', () => {
  ...
  const expectedSchema = makeExecutableSchema({
    ...
    describe('Types', () => {
      describe('Item', () => {
        ...
        const expectedFields = new Map([
          ...
          ['image_url', graphql.GraphQLString],
          [
            'description',
            new graphql.GraphQLNonNull(graphql.GraphQLString),
          ],
          ['owner', expectedItemFields.itemowner.type],
          ['created_at', expectedItemFields.created.type],
      ...
      describe('Tag', () => {
        ...
        describe('fields & types:', () => {
          for (let [field, type] of expectedFields) {
            test(`${field}: ${type}`, () => {
              expect(tagFields[field].type.toString()).toEqual(
                type.toString(),
              )
            })
          }
